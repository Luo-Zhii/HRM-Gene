...
describe('NotificationsGateway', () => {
  ...
  describe('handleConnection', () => {
    // [TC_BE_NOTIFI_213]
    it('Từ chối client không có auth token',
    ...
    // [TC_BE_NOTIFI_214]
    it('Xác thực JWT token và gán userId vào client data',
    ...
    // [TC_BE_NOTIFI_215]
    it('Ngắt kết nối khi JWT token không hợp lệ',
  ...
  describe('handleDisconnect', () => {
    // [TC_BE_NOTIFI_216]
    it('Xóa socket khỏi userSockets map khi client ngắt kết nối',
      const mockClient = { handshake: { auth: { token: 'token' } }, disconnect: jest.fn(), data: {}, id: '1' } as any;
      mockJwtService.verify.mockReturnValue({ sub: 1 });
      gateway.handleConnection(mockClient);
  ...
  describe('sendNotificationToUser', () => {
    // [TC_BE_NOTIFI_217]
    it('Emit notification đến đúng socket của user qua server.to()',
